...
class SharedHelper:
    ...
    def _checkAndAwardBadges(user: User) -> None:
        """[PRIVATE] Award any badges the user now qualifies for (based on points)."""
    ...
    def _getFeaturedPromos():
        """[PRIVATE] Internal helper — returns active promos queryset."""
...
#     SharedHelper.checkAndAwardBadges(user)
# 
# 
...
# ==============================================================================================================================================================================================================================
# TODO MAKE THIS A CLASS AND CONVERT IT TO BE LIKE OTHER BRANCHES AND USE CAMEL CASE FOR ATTRIBUTSE/METHODS, PASCAL CASE FOR CLASSES
# ==============================================================================================================================================================================================================================

# TODO: Done Done (Recheck functionality)
...
class BookView:
    ...
    def detail(request, book_id: int) -> HttpResponse:
        ...
        # TODO USE MAKE THE OBJECT BEFORE SENDING
    ...
    # TODO CHANGE Order AND UserBook TO THE CORRECT MODEL NAMES
    @staticmethod
    @require_POST
    def buy(request, book_id: int) -> JsonResponse:
        def logic(req, current_user, current_book):
            ...
            if BookActionHelper.checkOwnership(current_user, current_book.id):  # public: cross-class check
    ...
    # TODO MAKE A FUNCTION THAT HAS A PIPLINE
    # 1- SharedHelper.loginRequired(request)
    # 2- prefom logic (logic is either buy, borrow or add review)
    @staticmethod
    @require_POST
    ...
    def add_review(request, book_id: int) -> JsonResponse:
        def logic(req, current_user, current_book):
            ...
            Review.objects.create(
                book=current_book, user=current_user, user_name=current_user.name, rating=rating, comment=comment
            )
