...
class BookView:
    ...
    # TODO ADD COMMENTS AND  _ BEFORE ANY PRIVATE METHOD
    @staticmethod
    @require_GET
    def detail(request, book_id: int) -> HttpResponse:
        ...
        return render(
            request,
            "book-view.html",
            # THIS IS THE OBJECT I MEANT ABOVE
            {
                "book": book,
                "reviews": reviews,
                "owned": owned,
...
# TODO IF YOU CAN REMOVE THESE WRAPPER FUNCTIONS WHILE KEEPING GOOD STYLE DO IT
@require_GET
